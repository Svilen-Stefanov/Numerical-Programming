...
public class TridiagonalMatrix {
	...
	/**
	 * Die Matrix hat z.B. mit dim=3 folgendes Aussehen: d[0] u[0] 0 l[0] d[1]
	 * u[1] 0 l[1] d[2]
	 */
	...
	/**
	 * Belegt die untere Nebendiagonale mit lower, die Diagonale mit diag und
	 * die obere Nebendiagonale mit upper
	 */
