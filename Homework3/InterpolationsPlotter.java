 ...
 * @author braeckle
 *
 *         Diese Klasse bietet eine GUI fuer die Darstellung einer
 *         Interpolation. gruen : die Funktion f rot: Interpolant blau
 *         Stützpunkte
 *
 *******************************************************************************************************************/
public class InterpolationsPlotter extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source == (JComponent) interpolationmodeBox) {
			plotComponent.setInterpolationMethod(interpolationmodeBox
					.getSelectedIndex());
		} else if (source == (JComponent) functionsBox) {
			plotComponent.setFunction(functionsBox.getSelectedIndex());
		} else if (source == (JComponent) aField
				|| source == (JComponent) bField
				|| source == (JComponent) nField) {
			plotComponent.setSamplingPoints(Integer.parseInt(aField.getText()),
