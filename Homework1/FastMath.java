...
public class FastMath {
	...
	public static Gleitpunktzahl invSqrt(Gleitpunktzahl x) {
		Gleitpunktzahl err = new Gleitpunktzahl();
		err.setNaN();
		if(x.compareAbsTo(new Gleitpunktzahl(0)) == 0 || x.vorzeichen) return err;
		int t = gleitpunktzahlToIEEE(x);
		t = MAGIC_NUMBER - t/2;
		return iEEEToGleitpunktzahl(t);
	}
